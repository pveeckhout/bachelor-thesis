...
public class BIFHandler extends DefaultHandler {
     ...
     * The current section.
     */
    private final List<FileSection> currentSection =
            new ArrayList<FileSection>();
    /**
     * BIF variables.
     */
     ...
     * BIF definitions.
     */
    private final List<BIFDefinition> bifDefinitions =
            new ArrayList<BIFDefinition>();
    /**
    ...
    public void endDocument() throws SAXException {
        ...
        for (BIFDefinition d : this.bifDefinitions) {
            ...
            do {
                for (int result = 0; result < childEvent.getChoices().size();
                        result++) {
