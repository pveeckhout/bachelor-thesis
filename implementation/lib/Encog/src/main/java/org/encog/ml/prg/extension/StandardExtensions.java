...
public class StandardExtensions {
    ...
    public static ProgramExtensionTemplate EXTENSION_CONST_SUPPORT =
        ...
        @Override
        public void randomize(final Random rnd,
                              final List<ValueType> desiredType,
                              final ProgramNode actual,
                              final double minValue, final double maxValue) {
            ...
            switch (pickedType) {
                ...
                case intType:
                    ...
                    break;
                case enumType:
                    final int enumType = rnd.nextInt(context.getMaxEnumType() +
                            1);
                    final int enumCount = context.getEnumCount(enumType);
                    final int enumIndex = rnd.nextInt(enumCount);
                    actual.getData()[0] = new ExpressionValue(enumType,
                                                              enumIndex);
                    break;
            }
        }
