...
public class TaskReplaceNode implements TreeTraversalTask {
    ...
    public TaskReplaceNode(ProgramNode theReplaceThisNode,
                           ProgramNode theReplaceWith) {
    ...
    public static void process(ProgramNode rootNode, ProgramNode replaceThisNode,
