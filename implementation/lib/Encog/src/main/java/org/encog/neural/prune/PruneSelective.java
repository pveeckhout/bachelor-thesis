...
public class PruneSelective {
            ...
            for (int toNeuron = 0; toNeuron < toNeuronCount; toNeuron++) {
                for (int fromNeuron = 0; fromNeuron < fromNeuronCount;
                    ...
                    if ((toLayer == targetLayer) &&
                        ...
                        newWeights[weightsIndex++] = this.network.getFlat()
                                .getWeights()[oldWeightsIndex++];
                    }
                }
            }
        }
    ...
    private void randomizeNeuron(final int targetLayer, final int neuron,
                                 final boolean useRange, final double low,
                                 final double high,
    ...
    private void reindexNetwork() {
        ...
        flat.setInputCount(
                flat.getLayerFeedCounts()[flat.getLayerCounts().length - 1]);
