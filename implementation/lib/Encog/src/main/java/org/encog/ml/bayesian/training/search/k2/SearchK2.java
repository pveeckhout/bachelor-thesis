...
public class SearchK2 implements BayesSearch {
     ...
     * The node ordering.
     */
    private final List<BayesianEvent> nodeOrdering =
            new ArrayList<BayesianEvent>();
    /**
     * THe current index.
     */
    private int index = -1;
     ...
     * data, where the
     * desiredValue matches the training data. Only cases where the parents
     * match the specifed
     ...
     * @param parents        The parents of the specified event we are
     *                       considering.
