...
public class AnalystTestingUtility {
    ...
    public void process(double maxError) {
        ...
        Assert.assertTrue("Too many cycles to perform successful train.",
                          cycles <= MAX_CYCLES);
    ...
    public MLMethod obtainMethod() {
        final ScriptProperties prop = this.encogAnalyst.getScript()
                .getProperties();
        final String resourceID = prop.getPropertyString(
                ScriptProperties.ML_CONFIG_MACHINE_LEARNING_FILE);
        final File resourceFile = this.encogAnalyst.getScript().resolveFilename(
                resourceID);
    ...
    private MLDataSet obtainTrainingSet() {
        ...
        final File trainingFile = this.encogAnalyst.getScript().resolveFilename(
                trainingID);
    ...
    public void dumpAnalystField(int i) {
        AnalystField af = this.encogAnalyst.getScript().getNormalize()
                .getNormalizedFields().get(i);
    ...
    public void validateAnalystField(int i, double high, double low,
                                     double normHigh, double normLow,
