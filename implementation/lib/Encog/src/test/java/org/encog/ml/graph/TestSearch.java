...
public class TestSearch extends TestCase {
    ...
    public void testDepthFirstSearch() {
        ...
        DepthFirstSearch search = new DepthFirstSearch(graph, nodeA,
                                                       new SimpleDestinationGoal(
                nodeD));
    ...
    public void testBredthFirstSearch() {
        ...
        BreadthFirstSearch search = new BreadthFirstSearch(graph, nodeA,
                                                           new SimpleDestinationGoal(
                nodeD));
    ...
    public void testAStar() {
        ...
        BasicGraph graph = new BasicGraph(nodeA);
        BasicNode nodeB = graph.connect(nodeA, new EuclideanNode("b", 0, 2),
                                        10.0);
        BasicNode nodeC = graph
                .connect(nodeA, new EuclideanNode("c", 0, 1), 1.0);
        BasicNode nodeD = graph
                .connect(nodeB, new EuclideanNode("d", 0, 1), 1.0);
