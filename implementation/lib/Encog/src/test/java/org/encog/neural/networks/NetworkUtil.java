...
public class NetworkUtil {
    ...
    public static void testTraining(MLTrain train, double requiredImprove) {
        ...
        Assert.assertTrue("Improve rate too low for " + train.getClass()
                .getSimpleName() +
                ",Improve=" + improve + ",Needed=" + requiredImprove, improve >=
                requiredImprove);
    }
    ...
    public static FreeformNetwork createXORFreeformNetworkUntrained() {
        ...
        network.connectLayers(inputLayer, hiddenLayer1, new ActivationSigmoid(),
                              1.0, false);
        network
                .connectLayers(hiddenLayer1, outputLayer,
                               new ActivationSigmoid(), 1.0, false);
