...
public class TestExpressionVar extends TestCase {
    ...
    public void testAssignment() {
        ...
        Assert.assertEquals(5, expression.evaluate().toFloatValue(),
    ...
    public void testAssignment2() {
        ...
        Assert.assertEquals(9, expression.evaluate().toFloatValue(),
                            Encog.DEFAULT_DOUBLE_EQUAL);
    }
    ...
    public void testAssignment3() {
        ...
        Assert.assertEquals(6, expression.evaluate().toFloatValue(),
                            Encog.DEFAULT_DOUBLE_EQUAL);
    }

    public void testVarComplex() {
        EncogProgram expression = new EncogProgram(
                "(x^((1+((x^-8)-(4^x)))^(((-7/2)-(0--5.8))/x)))");
