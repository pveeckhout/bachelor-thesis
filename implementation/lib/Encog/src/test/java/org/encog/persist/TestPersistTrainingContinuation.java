...
public class TestPersistTrainingContinuation extends TestCase {
    ...
    public void testRPROPCont() {
        ...
        ResilientPropagation rprop1 =
                new ResilientPropagation(net1, trainingSet);
        ResilientPropagation rprop2 =
                new ResilientPropagation(net2, trainingSet);
        ...
        for (int i = 0; i < net1.getFlat().getWeights().length; i++) {
            Assert.assertEquals(net1.getFlat().getWeights()[i], net2.getFlat()
                    .getWeights()[i], 0.0001);
        }
    }
    ...
    public void testRPROPContPersistEG() {
        ...
        TrainingContinuation cont2 =
                (TrainingContinuation) EncogDirectoryPersistence.loadObject(
                EG_FILENAME);
