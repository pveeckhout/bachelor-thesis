...
The framework does it's job, it generates all different kinds of CAPTCHA images. The tests generated, the Captcha class, are implemented as an immutable data object, where all the variables cannot be changed once the class has been instantiated. (Code ~\ref{source:Captcha.java}, page ~\pageref{source:Captcha.java}
