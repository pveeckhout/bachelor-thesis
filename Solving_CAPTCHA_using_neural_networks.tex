...
\codefragment{source/TrainingSet.java}{The new trainingset container.}
\label{source:TrainingSet.java}

\codefragment{source/NeuralNetwork.java}{The abstract network class.}
\label{source:KohonenNetwork.java}
%
