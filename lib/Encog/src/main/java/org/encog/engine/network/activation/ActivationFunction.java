...
public interface ActivationFunction extends Serializable, Cloneable {
     ...
     * make
     * use of the result of the activation function. It is bad for performance
     * to
     * calculate this value twice. Yet, not all derivatives are calculated this
     * way.
     * By providing both the value before the activation function is applied
     * ("b"),
     * and after the activation function is applied("a"), the class can be
     * constructed
