...
public class TrainLinearRegression extends BasicTraining {
    ...
    public TrainLinearRegression(LinearRegression theMethod,
        ...
        super(theMethod.getInputCount() == 1
                ? TrainingImplementationType.OnePass
    ...
    public void iteration() {
        ...
        this.method.getWeights()[1] = ((m * sumXY) - (sumX * sumY)) / ((m *
                sumX2) - Math.pow(sumX, 2));
        this.method.getWeights()[0] = ((1.0 / m) * sumY) - ((this.method
                .getWeights()[1] / m) * sumX);
