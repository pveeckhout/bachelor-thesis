...
public class MajorityVoting implements EnsembleAggregator {
    ...
    public MLData evaluate(ArrayList<MLData> outputs, double threshold,
        ...
        for (MLData out : outputs) {
            MLData thresholdedOut = threshold(out, threshold, lowValue,
                                              highValue);
    ...
    private MLData threshold(MLData d, double threshold, double lowValue,
                             double highValue) {
