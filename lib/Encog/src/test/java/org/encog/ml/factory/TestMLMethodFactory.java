...
public class TestMLMethodFactory extends TestCase {
    ...
    public void testFactoryFeedforward() {
        ...
        BasicNetwork network = (BasicNetwork) factory.create(
                MLMethodFactory.TYPE_FEEDFORWARD, architecture, 1, 4);
    ...
    public void testFactoryRBF() {
        ...
        MLMethodFactory factory = new MLMethodFactory();
        RBFNetwork network = (RBFNetwork) factory.create(
                MLMethodFactory.TYPE_RBFNETWORK, architecture, 1, 4);
    ...
    public void testFactorySVM() {
        ...
        MLMethodFactory factory = new MLMethodFactory();
        SVM network = (SVM) factory.create(MLMethodFactory.TYPE_SVM,
                                           architecture, 4, 1);
