...
public class TestTrainingContinuation extends TestCase {
    ...
    public void testContRPROP() {
        ...
        ResilientPropagation rprop1 = new ResilientPropagation(network1,
                                                               trainingData);
        rprop1.iteration();
        rprop1.iteration();
        rprop1.iteration();
        ...
        ResilientPropagation rprop2 = new ResilientPropagation(network2,
                                                               trainingData);
        rprop2.iteration();
        rprop2.iteration();
    ...
    public void testContBackprop() {
        ...
        // train network 1, no continue
        Backpropagation rprop1 =
                new Backpropagation(network1, trainingData, 0.4, 0.4);
        rprop1.iteration();
        rprop1.iteration();
        rprop1.iteration();
        rprop1.iteration();
        ...
        // train network 2, continue
        Backpropagation rprop2 =
                new Backpropagation(network2, trainingData, 0.4, 0.4);
        rprop2.iteration();
        rprop2.iteration();
        TrainingContinuation state = rprop2.pause();
